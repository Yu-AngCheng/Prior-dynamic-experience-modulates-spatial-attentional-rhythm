...
n  = 22;
f = f(1:n);
PSD_pretest_even = PSD_pretest_even(1:n,:);
PSD_pretest_odd = PSD_pretest_odd(1:n,:);
PSD_post_odd = PSD_post_odd(1:n,:);
PSD_post_even = PSD_post_even(1:n,:);
%%
figure(30)
subplot(1,2,1);
PSD_even_diff = (PSD_post_even./PSD_post_even(1,:)) ./ ...
                (PSD_pretest_even./PSD_pretest_even(1,:));
n_perms = 10000;
[datobs, datrnd] = cluster_test_helper(PSD_even_diff-1,n_perms); % randomize data at each time-point
...
%%
subplot(1,2,2);
PSD_odd_diff = (PSD_post_odd./PSD_post_odd(1,:)) ./ ...
                (PSD_pretest_odd./PSD_pretest_odd(1,:));
n_perms = 10000;
